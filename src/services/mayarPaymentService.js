 ...
 * Menggunakan Endpoint Resmi Mayar: POST /hl/v1/qrcode/create
 */
...
export const MAYAR_CONFIG = {
  ...
  // Endpoint resmi Mayar API
  baseUrl: 'https://api.mayar.id/hl/v1'
};

/**
 * Buat Dynamic QRIS resmi Mayar.id melalui endpoint POST /hl/v1/qrcode/create
 * Mengembalikan gambar QRIS resmi Mayar yang valid dan siap discan dari semua m-Banking & E-Wallet
 */
export const createMayarQRISPayment = async ({
  ...
  try {
    // Panggil Endpoint Resmi Mayar Dynamic QRIS API
